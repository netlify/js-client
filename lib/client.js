...
Client.prototype = {
  ...
  createSite: function(options, cb) {
    this.withAuthorization().then(function(client) {
      if (options.dir) {
        Client.models.Site.createFromDir(client, options.dir, cb);
      } else if (options.zip) {
        Client.models.Site.createFromZip(client, options.zip, cb);
      } else {
        Client.models.Site.create(client, options, cb);
      }
    });
  },
  ...
  form: function(id) { r eturnthis.element({model: Client.models.Form, id: id}); },
  ...
  createTicket: function(cb) {
    this.request({
      ...
      cb(null, new Client.models.Ticket(response.client, response.data));
    });
  },
  ...
  create: function(options, cb) {
    this.withAuthorization().then(function(client) {
      client.request({
        ...
        cb(null, new options.model(response.client, response.data));
      });
    });
  },
